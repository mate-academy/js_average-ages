...
const averageAge = (myMassive) =>
  myMassive.reduce((sum, age) =>
    sum + (age.died - age.born), 0) / myMassive.length;
...
function calculateAverageAgeDiff(people, onlyWithSon) {
  ...
  const ages = childrens.reduce((sum, child) => {

...
/**
    ...
    @@ -55,7 +66,31 @@ function calculateWomenAverageAge(people, withChildren) {
...
function averageAge(people) {
  return (
    people.reduce((sum, { died, born }) => sum + died - born, 0) / people.length
  );
}

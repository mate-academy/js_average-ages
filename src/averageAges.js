...
calculateMenAverageAge(data, 18);
...
function calculateWomenAverageAge (people, withChildren) {
  ...
  // console.table(womenWithChildren);
  ...
  return Math.ceil(sumAge / womenWithChildren.length);
}

calculateWomenAverageAge(data, true);
console.log('average women age ===', calculateWomenAverageAge(data, true));
...
function calculateAverageAgeDiff(people, onlyWithSon) {
  ...
  // console.log('amount of moms', mothers);

  const ageDiffs = sons.map(son => {
  ...
  // console.log('difference ===', ageDiffs);

  const averageDiff =
    ageDiffs.reduce((sum, age) => sum + age, 0) / ageDiffs.length;

  return averageDiff;
}

calculateAverageAgeDiff(data, true);
console.log(calculateAverageAgeDiff(data, true));

...
function calculateAverageAgeDiff(people, onlyWithSon) {
  ...
  const result = people.reduce((differenceSum, child) => {
    ...
    mothersNumber = mother ? mothersNumber + 1 : mothersNumber;

    return mother ? differenceSum + (child.born - mother.born)
      : differenceSum;
  }, 0);
